...
def refine(adata, *, batch_key, label_key, counts=None, n_hvg=2000, hvg_genes=None,
           ...
           hvg_span='auto', query_hvg_span=None):
    ...
    manifest = dict(
        schema_version='0.11.0', software_versions=versions, engine_sha256=engine_hashes,
        ...
        risk_evidence_scope='reference_hvg_panel_on_reference_cells',
